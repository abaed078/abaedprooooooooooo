        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {["منطقة أمامية","منطقة خلفية","مدخل المشعاع","مخرج المشعاع"].map((z, i) => {
              const t = 24 + i * 5 + Math.random() * 3;
              const color = t > 40 ? "#ef4444" : t > 30 ? "#eab308" : "#22c55e";
              return (
                <div key={z} className="p-4 rounded-xl border border-border bg-card text-center">
                  ...
                  <div className="text-xl font-black font-mono" style={{ color }}>{(24 + i*5).toFixed(1)}°C</div>
          ...
          <div className="p-4 rounded-2xl border border-border bg-card">
            ...
            <div className="flex items-end gap-1 h-24">
              {Array.from({length:30},(_,i)=>24+Math.sin(i/4)*8+Math.random()*3).map((t,i)=>(
